...
hematology: LabResults = {
    ...
    "RBC": {
        ...
        "units": TRIL_PER_LITER,
        "description": "Red Blood Cell Count",
    },
    "Hemoglobin": {
        "result": 144,
        "reference_range": [135, 170],
        "units": G_PER_LITER,
    ...
    "MCH": {
        "result": 29.3,
        "reference_range": [27.5, 33.5],
        "units": PG,
        "description": "Mean Corpuscular Hemoglobin",
    },
    "MCHC": {
        "result": 329,
        "reference_range": [300, 370],
        "units": G_PER_LITER,
...
differential_hematology: LabResults = {
    ...
    "Granulocytes Immature": {
        ...
        "units": BIL_PER_LITER,
        "description": "Granulocytes Immature",
    },
}
...
general_chemistry: LabResults = {
    "Sodium": {
        ...
        "units": MMOL_PER_LITER,
        "description": "Sodium",
    },
    "Creatinine": {
        "result": 81,
        "reference_range": [45, 110],
        "units": UMOL_PER_LITER,
        "description": "Creatinine",
    },
    "Estimated GFR": {
        "result": 104,
        "reference_range": [60, INF],
        "units": NULL,
    ...
    "Alkaline Phosphatase": {
        "result": 93,
        "reference_range": [40, 145],
        "units": U_PER_LITER,
        "description": "Alkaline Phosphatase",
    },
    "Gamma GT": {
        "result": 79,
        "reference_range": [0, 65],
        "units": U_PER_LITER,
    ...
    "Aspartate Aminotransferase": {
        "result": 37,
        "reference_range": [0, 36],
        "units": U_PER_LITER,
        "description": "Aspartate Aminotransferase",
    },
    "Lactate Dehydrogenase": {
        "result": 212,
        "reference_range": [0, 225],
        "units": U_PER_LITER,
...
serum_proteins: LabResults = {
    ...
    "IgA": {
        "result": 1.15,
        "reference_range": [0.7, 4.0],
        "units": G_PER_LITER,
        "description": "IgA",
    },
    "IgM": {
        "result": 0.63,
        "reference_range": [0.4, 2.3],
        "units": G_PER_LITER,
        "description": "IgM",
    },
    "Ceruloplasmin": {
        "result": 0.32,
        "reference_range": [0.19, 0.31],
        "units": G_PER_LITER,
        "description": "Ceruloplasmin",
    },
    "Alpha 1 Antitrypsin": {
        "result": 1.28,
        "reference_range": [0.9, 2.18],
        "units": G_PER_LITER,
